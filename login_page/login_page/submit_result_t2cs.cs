...
{
    public partial class submit_result_t2cs : Form
    {
        public submit_result_t2cs()
        {
            InitializeComponent();
        }
        ...
        private void button_WOC10_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string my_query = "INSERT INTO t2_marks (mark1, mark2, mark3, mark4, total_marks) VALUES (@Mark1, @Mark2, @Mark3, @Mark4, @TotalMarks)";
