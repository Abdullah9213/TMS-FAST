...
{
    public partial class examier_change_request_form : Form
    {

        public examier_change_request_form()
        {
            InitializeComponent();
            FetchThesisRegistrationData2();
        }
        private void FetchThesisRegistrationData2()
        {
